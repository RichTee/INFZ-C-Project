...
CREATE TABLE `klant` (
  ...
  CONSTRAINT `FK_KlantGebruiker` FOREIGN KEY (`klantId`) REFERENCES `gebruiker` (`gebruikerId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `medewerker` (
  ...
  CONSTRAINT `FK_MedewerkerGebruiker` FOREIGN KEY (`medewerkerId`) REFERENCES `gebruiker` (`gebruikerId`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2015-12-11 14:48:57
